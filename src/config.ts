export default {
    sourceFolderPath: "C:\\迅雷下载", //需要处理的视频文件夹,(路径中不要出现\,用/代替,下同)
    destFolderPath: "E:\\ebdata\\test", //处理后的文件夹
    proxy: "http://127.0.0.1:7890", //代理,例如:http://127.0.0.1:7890
    websites: "missav,airav,javbus", //请求的网址
    videoTypes: ".mp4,.avi,.mkv,.mov", //识别的视频文件后缀名
    videoMinSize: 20, //识别的最小视频文件大小,单位:M (用来忽略掉一些广告视频文件)
    descriptionInsertWebsite: true,//在nfo文件描述后加入网站标签
